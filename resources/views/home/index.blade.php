...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
        <div class="container">
            ...
            <!-- Tombol toggle saat di mobile -->
            <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarContent"
                aria-controls="navbarContent" aria-expanded="false" aria-label="Toggle navigation">
                <span class="navbar-toggler-icon"></span>
            </button>

            <!-- Semua isi navbar masuk sini -->
            <div class="collapse navbar-collapse" id="navbarContent">
                <!-- Dropdown Filter Kategori dengan Custom SVG Icon -->
                <ul class="navbar-nav ms-3">
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle btn btn-outline-light d-flex align-items-center" href="#" id="kategoriDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                            {{-- Icon SVG --}}
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="me-1" viewBox="0 0 24 24">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="kategoriDropdown">
                            ...
                            <li><a class="dropdown-item" href="{{ route('blog.trending') }}">Trending</a></li>
                        </ul>
                    </li>
                </ul>
                
                <!-- Form Pencarian -->
                <form class="d-flex ms-3" role="search" action="{{ route('blog.index') }}" method="GET">
                    <div class="input-group">
                        <span class="input-group-text bg-white border-end-0">
                            <i class="typcn typcn-zoom"></i>
                        </span>
                        <input class="form-control border-start-0" type="search" name="search" placeholder="Cari artikel..." value="{{ request('search') }}">
                    </div>
                </form>
    ...
    <div class="container d-flex justify-content-center">
        {{ $blog->links('pagination::bootstrap-4', ['class' => 'pagination']) }}
    </div>
